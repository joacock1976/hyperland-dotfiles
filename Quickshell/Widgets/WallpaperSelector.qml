...
Item {
    ...
    Process {
        id: lister
        command: ["bash", "-c",
            "THUMB='" + Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/wallpaper-thumbnail.sh'; " +
    ...
    function applyWallpaper(path) {
        Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/apply-wallpaper.sh", path]);
    }
