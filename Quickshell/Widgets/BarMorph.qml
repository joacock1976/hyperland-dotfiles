                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                Quickshell.execDetached(["bash",
                                                    Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/apply-colorscheme-preset.sh",
                                                    scheme.name]);
                                            }
                                        }
                                    }
                        ...
                        ListView {
                            ...
                            delegate: Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        Quickshell.execDetached(["bash",
                                            Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/cliphist-restore.sh",
                                            modelData]);
                                        Local.AppState.closeMorph();
                                    }
                                }
            ...
            Component {
                ...
                Column {
                    ...
                    function applyWallpaper(path) {
                        ...
                        Quickshell.execDetached(["bash",
                            Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/apply-wallpaper.sh",
                            path, "grow", posX + "," + posY]);
                    }
                    ...
                    Process {
                        id: wpLister
                        command: ["bash",
                            Quickshell.env("HOME") + "/.config/quickshell/prueba/Scripts/wallpaper-list-thumbnails.sh"]
                        running: true
                        stdout: StdioCollector {
                            onStreamFinished: {
